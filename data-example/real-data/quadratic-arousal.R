...
y.dat=as.matrix(dat.use)

############################## Processing data ##########################
source("code/BinaryFunAll.R")

dat.processed=data_processing(y.dat,C=4)


#### for the first component of the continuation-ratio logit

pool.grid.idx1=pool_grid(dat.processed[[4]])
y.dat1=dat.processed[[1]][,pool.grid.idx1]
idx.mtx1=dat.processed[[4]][,pool.grid.idx1]


# pool.grid.idx2=pool_grid(dat.processed[[5]])
# y.dat2=dat.processed[[2]][,pool.grid.idx2]
# idx.mtx2=dat.processed[[5]][,pool.grid.idx2]
# 
# pool.grid.idx3=pool_grid(dat.processed[[6]])
# y.dat3=dat.processed[[3]][,pool.grid.idx3]
# idx.mtx3=dat.processed[[6]][,pool.grid.idx3]


############### Fit the model with filtered binary data ############################
...
## for the second component of the continuation-ratio logit

pool.grid.idx1=pool_grid(dat.processed[[5]])
y.dat1=dat.processed[[2]][,pool.grid.idx1]
idx.mtx1=dat.processed[[5]][,pool.grid.idx1]
...
## for the third component of the continuation-ratio logit

pool.grid.idx1=pool_grid(dat.processed[[6]])
y.dat1=dat.processed[[3]][,pool.grid.idx1]
idx.mtx1=dat.processed[[6]][,pool.grid.idx1]
